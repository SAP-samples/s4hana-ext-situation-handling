...
/**
 * Event that comes from Enterprise Messaging Service as JSON via REST Messaging
 * API.
 * <p>
 * Example JSON object:<br>
 * 
 * {<br>
 *	  "eventType": "BO.BusinessSituation.Created",<br>
...
@JsonSubTypes({
	@JsonSubTypes.Type(value = BusinessSituationEvent.class, name = BusinessSituationEvent.JSON_TYPE_ID_CREATED),
	@JsonSubTypes.Type(value = BusinessSituationEvent.class, name = BusinessSituationEvent.JSON_TYPE_ID_CHANGED)
})
